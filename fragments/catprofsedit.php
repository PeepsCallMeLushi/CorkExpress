...
$edit = mysqli_fetch_array(mysqli_query($conn, "SELECT nome_catprof from categprofissional where id_catprof = '$_SESSION[editID]'"));
           ...
           <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
             <div class="container">
               ...
               <div class="row">
                 ...
                 <div class="col-6 col-md-4">
                   <input type="text" id="text-input" name="nome_catprof" placeholder="Nome da categoria" class="form-control" value="<?php echo ''.$edit["nome_catprof"].''?>">
                 </div>
                 <div class="col-6 col-md-4">
                   <form method="post">
                     <button type="submit" class="btn btn-warning btn-sm" name="submitInfo">Submeter edição</button>
                   </form>
                 </div>
               </div>
             </div>
            ...
            <tbody>
              ...
              include 'connections/conn.php';
                $cats = mysqli_query($conn, "SELECT departamento.nome_depart, categprofissional.nome_catprof, categprofissional.id_catprof from categprofissional
                  left join departamento on categprofissional.id_departamento = departamento.id_depart where id_catprof != '$_SESSION[editID]'");
                ...
                if (isset($_POST["submitInfo"])) {
                  include 'connections/conn.php';
                  mysqli_query($conn, "UPDATE categprofissional set nome_catprof = '$_POST[nome_catprof]' where id_catprof = '$_SESSION[editID]'");
                  echo '<meta http-equiv="refresh" content="0;url=platform.php?an=4">';
                  include 'connections/dconn.php';
                }
              ?>
