                ...
                while($list = mysqli_fetch_array($users)){
                  ...
                  '<tr>
                    ...
                    <td>
                      <div class="table-data__info">
                          <h6>';
                          $trabalhadores = mysqli_fetch_array(mysqli_query($conn, "SELECT nome_users,email from utilizador where id_users = '$list[id_trabalhador]'"));
                          echo ''.$trabalhadores["nome_users"].'</h6>
                          <span>
                              <a href="#">'.$trabalhadores["email"].'</a>
                          </span>
                      </div>
                      </td>
                      <td>
